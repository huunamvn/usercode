            ...
            <div class="tf-section-4 mb-30">
                    ...
                    <div class="top">
                        <div class="flex items-center gap14">
                            <div class="image type-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 48 52"
                                    fill="none">
                                    <path
                                ...
                                <span class="icon">
                                    <svg width="19.5" height="19.5" viewBox="0 0 20 21" fill="none"
                ...
                <div class="wg-chart-default">
                    <div class="top">
                        <div class="flex items-center gap14">
                            <div class="image type-white">
                                <svg width="52" height="52" viewBox="0 0 48 52" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="dropdown default style-box">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                    ...
                                    <a href="product-list.html" class="view-all">Weekly<i
                        ...
                        <ul class="flex flex-column h-full has-divider-line">
                            <li class="wg-product">
                                <div class="name flex-grow">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                                        <div class="title">
                            ...
                            <li class="wg-product">
                                <div class="name flex-grow">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                                        <div class="title">
                            ...
                            <li class="wg-product">
                                <div class="name flex-grow">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-3.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                                        <div class="title">
                            ...
                            <li class="wg-product">
                                <div class="name flex-grow">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-4.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                                        <div class="title">
                            ...
                            <li class="wg-product">
                                <div class="name flex-grow">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-5.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                                        <div class="title">
                            ...
                            <li class="wg-product">
                                <div class="name flex-grow">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-6.jpg') }}"
                                            alt="">
                                    </div>
                                    <div>
                                        <div class="title">
                    ...
                    <div class="wg-table table-recent-orders">
                        ...
                        <ul class="flex flex-column has-divider-line has-line-bot">
                            ...
                            <li class="item wg-product gap20">
                                <div class="name">
                                    <div class="image">
                                        <img src="{{ asset('admins/assets/images/products/product-7.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="title mb-0">
                                        <a href="#" class="body-text">Oversized Motif T-shirt</a>
                        ...
                        <div class="bot">
                            <div class="flex items-center justify-between gap20 mb-20">
                                <div class="block-legend">
                                    ...
                                    <div class="text-tiny text-surface-2">California <span
                                            class="fw-7 text-main-dark">40%</span></div>
                                </div>
                                <div class="block-legend">
                                    <div class="dot t6"></div>
                                    <div class="text-tiny text-surface-2">Arizona <span
                                            class="fw-7 text-main-dark">15%</span></div>
                                </div>
                                <div class="block-legend">
                                    <div class="dot t3"></div>
                                    <div class="text-tiny text-surface-2">Texas <span
                                            class="fw-7 text-main-dark">10%</span></div>
                                </div>
                            </div>
                            <div class="flex items-center justify-between gap20">
                                <div class="block-legend">
                                    <div class="dot t3"></div>
                                    <div class="text-tiny text-surface-2">Georda <span
                                            class="fw-7 text-main-dark">3.5%</span></div>
                                </div>
                                <div class="block-legend">
                                    <div class="dot t3"></div>
                                    <div class="text-tiny text-surface-2">North Carolina <span
                                            class="fw-7 text-main-dark">2%</span></div>
                                </div>
                                <div class="block-legend">
                                    <div class="dot t3"></div>
                                    <div class="text-tiny text-surface-2">Florida <span
                                            class="fw-7 text-main-dark">1.5%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
